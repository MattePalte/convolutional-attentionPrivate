...
if __name__ == "__main__":
    ...
    for p in projects:
        ...
        input_file = os.path.join(ROOT, train)
        sys.stdout = open(p + 'train.log', 'w')
        print input_file
        print params["test_file"]
        ...
        with ExperimentLogger("ConvolutionalCopyAttentionalRecurrentLearner", params) as experiment_log:
            if max_num_epochs:
                ...
                model.save(p + "_copy_convolutional_att_rec_model.pkl")
            ...
            model2 = ConvolutionalCopyAttentionalRecurrentLearner.load(p + "_copy_convolutional_att_rec_model.pkl")
